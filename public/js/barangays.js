if (document.getElementById("search-table") && typeof simpleDatatables.DataTable !== 'undefined') {
    ...
    const editbarangayinfoform = document.getElementById('editbarangayinfoform');
    const editbarangayinfoformcontainer = document.getElementById('editbarangayinfoformcontainer');

    editbarangayinfoform.querySelector('.closeformbtn').onclick = function() {
        editbarangayinfoformcontainer.classList.remove('flex');
        editbarangayinfoformcontainer.classList.add('hidden');
    };

    document.querySelectorAll('.editbtn').forEach(btn => {
        btn.onclick = function() {
            const data = JSON.parse(btn.getAttribute('data-barangay'));
            console.log(data);
            
            editbarangayinfoformcontainer.classList.remove('hidden');
            editbarangayinfoformcontainer.classList.add('flex');

            editbarangayinfoform.querySelector('#id').value = data.id;
            editbarangayinfoform.querySelector('#name').value = data.name;
            editbarangayinfoform.querySelector('#latitude').value = data.lat;
            editbarangayinfoform.querySelector('#longitude').value = data.lng;
            editbarangayinfoform.querySelector('#population').value = Number(data.population);
        }; 
    });

    document.getElementById('editbarangayinfoform').addEventListener('submit', function(e) {
        e.preventDefault();
