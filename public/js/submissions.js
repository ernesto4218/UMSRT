if (document.getElementById("search-table") && typeof simpleDatatables.DataTable !== 'undefined') {
   ...
   document.getElementById("export-json").addEventListener("click", () => {
    ...
    const submittedformcontainer = document.getElementById('submittedformcontainer');
    const closesubmittedformbtn = document.querySelector('.closesubmittedformbtn');
    closesubmittedformbtn.onclick = function() {
        submittedformcontainer.classList.remove('flex');
        submittedformcontainer.classList.add('hidden');
    };
